...
# test.py 파일을 학습률, 피처 타입, 모델 타입에 대해 실행
...
echo "모든 테스트 작업이 완료되었습니다."

# # 모든 결과를 종합하는 aggregate_results.py 실행
# echo "결과 종합 시작"
# python aggregate_results.py --results_root /workspace/UndergraduateResearchAssistant/GraduateProject/code/CREMA-D/jihan/ --output_file aggregated_results.md
