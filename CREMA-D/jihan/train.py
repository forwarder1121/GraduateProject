...
from utils import plot_fold_performance, get_mfcc, get_melspectrogram
...
def main():
    ...
    if args.feature_type == 'mfcc':
        fold_data = get_kfold_data(root='/workspace/dataset/CREMA-D/train_without_XX', n_mfcc=args.n_mfcc, feature_type='mfcc')
