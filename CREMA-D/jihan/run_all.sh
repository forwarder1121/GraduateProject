...
echo "결과 종합 시작"
python aggregate_results.py --results_root /workspace/UndergraduateResearchAssistant/GraduateProject/code/CREMA-D/jihan/ --test_data_root /workspace/dataset/CREMA-D/test --output_file aggregated_results.md
