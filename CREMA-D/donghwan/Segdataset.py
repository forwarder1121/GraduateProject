...
if __name__ == "__main__":
    try:
        ...
        feature_type = 'melspectrogram'  # 'mfcc' 또는 'melspectrogram'
        n_mfcc = 20
        n_mels = 128
        k_folds = 5
        ...
        # K-Fold 데이터 준비
        k_folds_data = get_kfold_data(root=root, feature_type=feature_type, n_mfcc=n_mfcc, n_mels=n_mels, k_folds=k_folds, random_state=1, target_length=target_length)
        ...
        for fold_idx, (train_mfcc, val_mfcc, train_emotion, val_emotion) in enumerate(k_folds_data):
            ...
            if len(train_dataset) > 0:
                ...
                print("Sample Feature shape:", sample_mfcc.shape)
