...
| 모델        | 학습률  | Fold 1 | Fold 2 | Fold 3 | Fold 4 | Fold 5 | 평균 정확도 | 평균 F1 스코어 | 평균 정밀도 | 평균 재현율 |
|-------------|---------|--------|--------|--------|--------|--------|-------------|----------------|-------------|-------------|
| CNN         | 1e-05   | 0.733  | 0.737  | 0.717  | 0.742  | 0.744  | 0.735       | 0.791          | 0.856       | 0.735       |
| CNN         | 3e-05   | 0.735  | 0.729  | 0.739  | 0.738  | 0.748  | 0.738       | 0.793          | 0.863       | 0.732       |
| CNN         | 5e-05   | 0.686  | 0.699  | 0.697  | 0.682  | 0.682  | 0.689       | 0.753          | 0.823       | 0.694       |
| ResNetCNN   | 1e-05   | 0.763  | 0.755  | 0.769  | 0.769  | 0.755  | 0.762       | 0.815          | 0.869       | 0.768       |
| ResNetCNN   | 3e-05   | 0.768  | 0.770  | 0.765  | 0.760  | 0.769  | 0.766       | 0.817          | 0.878       | 0.765       |
| ResNetCNN   | 5e-05   | 0.769  | 0.770  | 0.751  | 0.751  | 0.776  | 0.763       | 0.816          | 0.868       | 0.771       |
| VGG_CNN     | 1e-05   | 0.780  | 0.773  | 0.749  | 0.766  | 0.770  | 0.768       | 0.821          | 0.866       | 0.781       |
| VGG_CNN     | 3e-05   | 0.770  | 0.760  | 0.766  | 0.747  | 0.766  | 0.762       | 0.814          | 0.872       | 0.764       |
| VGG_CNN     | 5e-05   | 0.768  | 0.764  | 0.774  | 0.758  | 0.767  | 0.766       | 0.820          | 0.866       | 0.779       |
