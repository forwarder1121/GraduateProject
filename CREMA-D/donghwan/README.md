...
##  실험 결과 (10.14(일) 결과) - 조기종료 적용

| 모델       | 학습률   | Fold 1 | Fold 2 | Fold 3 | Fold 4 | Fold 5 | 평균 정확도 | 평균 F1 스코어 | 평균 정밀도 | 평균 재현율 |
|------------|----------|--------|--------|--------|--------|--------|--------------|----------------|--------------|--------------|
| CNN        | 0.00001  | 0.671  | 0.661  | 0.651  | 0.668  | 0.661  | 0.662        | 0.726          | 0.814        | 0.656        |
| CNN        | 0.00003  | 0.681  | 0.694  | 0.669  | 0.696  | 0.669  | 0.682        | 0.738          | 0.845        | 0.655        |
| CNN        | 0.00005  | 0.702  | 0.684  | 0.697  | 0.689  | 0.715  | 0.698        | 0.754          | 0.846        | 0.682        |
| ResNetCNN  | 0.00001  | 0.685  | 0.686  | 0.676  | 0.674  | 0.691  | 0.682        | 0.738          | 0.846        | 0.655        |
| ResNetCNN  | 0.00003  | 0.727  | 0.717  | 0.749  | 0.736  | 0.717  | 0.729        | 0.783          | 0.862        | 0.718        |
| ResNetCNN  | 0.00005  | 0.747  | 0.769  | 0.721  | 0.735  | 0.741  | 0.743        | 0.800          | 0.851        | 0.755        |
| VGG_CNN    | 0.00001  | 0.707  | 0.709  | 0.697  | 0.692  | 0.695  | 0.700        | 0.756          | 0.850        | 0.681        |
| VGG_CNN    | 0.00003  | 0.721  | 0.743  | 0.731  | 0.732  | 0.736  | 0.733        | 0.790          | 0.850        | 0.739        |
| VGG_CNN    | 0.00005  | 0.735  | 0.729  | 0.718  | 0.730  | 0.717  | 0.726        | 0.782          | 0.856        | 0.720        |
