...
class Args:
    def __init__(self):
        ...
        self.save_root = '/workspace/UndergraduateResearchAssistant/GraduateProject/code/EmotionFreeTaking/checkpoints/Transformer'  # 모델 체크포인트를 저장할 경로

        # 학습 설정
        self.epoch = 100  # 학습 에포크 수
        self.lr = 3e-4  # 학습률
        self.batch_size = 16  # 배치 크기 배치 사이즈 16 -> 1600으로 상향 조절. 데이터 수 100배 넘게 되었으므로 ->350으로 축소 (gpu 메모리 부족)
        ...
        self.model_type = 'Transformer'  # 사용할 모델 타입 ('CNN', 'RNN', 'Transformer' 중 하나)
