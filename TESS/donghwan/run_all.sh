...
echo "결과 종합 시작"
python aggregate_results.py --results_root /workspace/UndergraduateResearchAssistant/GraduateProject/code/TESS/donghwan/ --output_file aggregated_results.md
