...
def main():
    ...
    if args.feature_type == 'mfcc':
        test_features, test_labels = read_test_file_list(root='/workspace/dataset/TESS/test', feature_type='mfcc', n_mfcc=args.n_mfcc, n_mels=args.n_mels)
        in_channels = args.n_mfcc
    elif args.feature_type == 'mel':                                                
        test_features, test_labels = read_test_file_list(root='/workspace/dataset/TESS/test', feature_type='mel', n_mfcc=args.n_mfcc, n_mels=args.n_mels)
